...
[`/poteto-mode`](./skills/poteto-mode/SKILL.md) works extremely well with OMP's loop, a `hub`-managed repeating process. you can run many hours without sacrificing rigor.
